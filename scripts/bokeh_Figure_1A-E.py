"""
Interactive plots for maps included in Figure 1A-E
"""
...
# python3 scripts/bokeh_Figure_1.py --input_A ${DB}.map.csv --input_B ${DB}.pca.evec -p ${DB}_pca.csv --output 01-Main_Figures/Figure_1
#
...
# Figure 1A. Map.
title_a= "Figure 1A | Geographical distribution of Fulani individuals"
print ('Plotting Map')
...
tooltips = [("Population","@Population"), ("N_samples","@N")]
...
plot_a= figure(title= title_a, toolbar_location="above", x_axis_type= "mercator", x_axis_label= 'Longitude', y_axis_type= "mercator", y_axis_label= 'Latitude', 
	tooltips= tooltips, height= 500, width= 1300,
...
plot_a.title.text_font_size = '17pt'

#plot_a.xaxis.axis_label="Longitude"
plot_a.xaxis.axis_label_text_font_size = "14pt"
plot_a.xaxis.major_label_text_font_size = "12pt"
...
plot_a.yaxis.axis_label_text_font_size = "14pt"
plot_a.yaxis.major_label_text_font_size = "12pt"
...
plot_a.legend.label_text_font_size = '12pt'
...
plot_b = figure(title=title_a, toolbar_location="above", x_axis_label="PC"+str(which_pcs[0]), y_axis_label="PC"+str(which_pcs[1]), width=600, height= 500,
...
plot_b.title.text_font_size = '16pt'

#plot_b.xaxis.axis_label="PC1"
plot_b.xaxis.axis_label= "PC"+str(which_pcs[0])+' ('+"%.2f" % eval_per[which_pcs[0]-1]+'% var explained)'
plot_b.xaxis.axis_label_text_font_size = '13pt'
plot_b.xaxis.major_label_text_font_size = '12pt'
...
plot_b.yaxis.axis_label_text_font_size = '13pt'
plot_b.yaxis.major_label_text_font_size = '12pt'
...
plot_c = figure(title=title_c, toolbar_location="above", x_axis_label="PC"+str(which_pcs[0]), y_axis_label="PC"+str(which_pcs[1]), width=600, height= 500,
	tools='pan,box_zoom,wheel_zoom,ywheel_zoom,undo,xzoom_in,redo,reset,save', active_scroll='wheel_zoom', background_fill_color="#fafafa", output_backend="svg")
...
plot_c.title.text_font_size = '16pt'

#plot_c.xaxis.axis_label="PC1"
plot_c.xaxis.axis_label= "PC"+str(which_pcs[0])+' ('+"%.2f" % eval_per[which_pcs[0]-1]+'% var explained)'
plot_c.xaxis.axis_label_text_font_size = '13pt'
plot_c.xaxis.major_label_text_font_size = '12pt'
...
plot_c.yaxis.axis_label_text_font_size = '13pt'
plot_c.yaxis.major_label_text_font_size = '12pt'
...
# PCA Plot 1D
title_c= "Figure 1D | PC1 vs PC3"
which_pcs= (1,3)
print ('Plotting',['PC' + str(p) + ' ' for p in which_pcs])

plot_d = figure(title=title_c, toolbar_location="above", x_axis_label="PC"+str(which_pcs[0]), y_axis_label="PC"+str(which_pcs[1]), width=600, height= 500,
	tools='pan,box_zoom,wheel_zoom,ywheel_zoom,undo,xzoom_in,redo,reset,save', active_scroll='wheel_zoom', background_fill_color="#fafafa", output_backend="svg")
...
plot_d.title.text_font_size = '16pt'

#plot_d.xaxis.axis_label="PC1"
plot_d.xaxis.axis_label= "PC"+str(which_pcs[0])+' ('+"%.2f" % eval_per[which_pcs[0]-1]+'% var explained)'
plot_d.xaxis.axis_label_text_font_size = '13pt'
plot_d.xaxis.major_label_text_font_size = '12pt'
...
plot_d.yaxis.axis_label_text_font_size = '13pt'
plot_d.yaxis.major_label_text_font_size = '12pt'
...
# PCA Plot 1E
title_c= "Figure 1E | PC2 vs PC3"
which_pcs= (2,3)
print ('Plotting',['PC' + str(p) + ' ' for p in which_pcs])

plot_e = figure(title=title_c, toolbar_location="above", x_axis_label="PC"+str(which_pcs[0]), y_axis_label="PC"+str(which_pcs[1]), width=600, height= 500,
	tools='pan,box_zoom,wheel_zoom,ywheel_zoom,undo,xzoom_in,redo,reset,save', active_scroll='wheel_zoom', background_fill_color="#fafafa", output_backend="svg")
...
plot_e.title.text_font_size = '16pt'

#plot_e.xaxis.axis_label="PC1"
plot_e.xaxis.axis_label= "PC"+str(which_pcs[0])+' ('+"%.2f" % eval_per[which_pcs[0]-1]+'% var explained)'
plot_e.xaxis.axis_label_text_font_size = '13pt'
plot_e.xaxis.major_label_text_font_size = '12pt'
...
plot_e.yaxis.axis_label_text_font_size = '13pt'
plot_e.yaxis.major_label_text_font_size = '12pt'
