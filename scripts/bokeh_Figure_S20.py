#!/usr/bin/python
"""
Plotting script for Suppl Figure S20
"""
...
parser.add_argument('-o', '--output', default='02-Suppl_Figures/Figure_S20')
args = parser.parse_args()

# Usage:
#
# python3 scripts/bokeh_Figure_S20.py --output "02-Suppl_Figures/Figure_S20"

# Data
title='Figure S20 | Effective population sizes (Ne) estimated for each Fulani group.'
...
# pop_a
leg_1 = []
pop_name= ['Gambia_Fula','Guinea_Fulani','Senegal_Fulani_Linguere','Senegal_Halpularen','Mauritania_Fulani_Assaba','Mali_Fulani_Diafarabe']
pop_data= ([Gambia_Fula,Guinea_Fulani,Senegal_Fulani_Linguere,Senegal_Halpularen,Mauritania_Fulani_Assaba,Mali_Fulani_Diafarabe])
# Plotting pattern																				
colours= ['#49A0B6','#74B5C3','#3B9AB2','#57A7BA','#66AEBF','#8CBAA9']
filling= ['None','None','None','None','None','None']

plot_a = figure(title=title, x_range=[4, 50], y_range=[1E2, 1E16], toolbar_location="above", width= 1180, height= 600,
...
for counter,pop in enumerate(pop_name):
	leg_1.append((pop, [plot_a.line(name=pop, x=generations, y=pop_data[counter], muted_alpha=0.2, line_width=5, line_color=colours[counter]) ] )) # , line_dash=line_dash[counter]
...
#plot_a.xaxis.axis_label=""
plot_a.xaxis.axis_label_text_font_size= "17pt"
plot_a.xaxis.major_label_text_font_size= "16pt"
...
plot_a.xaxis.major_tick_line_width= 4

#plot_a.yaxis.axis_label=""
...
plot_a.yaxis.major_tick_line_width= 4
...
plot_a.legend.location = "top_center"
plot_a.legend.click_policy="hide" #"mute"
plot_a.legend.label_text_font_size = '10pt'
plot_a.legend.label_text_font_style= "normal" # "bold" or "italic"
...
# pop_b
leg_1 = []
pop_name= ['Mali_Fulani_InnerDelta','BurkinaFaso_Fulani_Banfora','BurkinaFaso_Fulani_Tindangou','BurkinaFaso_Fulani_Ziniare','Niger_Fulani_Abalak','Niger_Fulani_Ader']
pop_data= ([Mali_Fulani_InnerDelta,BurkinaFaso_Fulani_Banfora,BurkinaFaso_Fulani_Tindangou,BurkinaFaso_Fulani_Ziniare,Niger_Fulani_Abalak,Niger_Fulani_Ader])
# Plotting pattern																				
colours= ['#C2C460','#A7BF85','#E9C825','#DDC93C','#E5BA11','#E7C11B']
filling= ['None','None','None','None','None','None']

plot_b = figure(title='', x_range=[4, 50], y_range=[1E2, 1E9], toolbar_location="above", width= 1200, height= 400,
	x_axis_label="Generations", y_axis_label="Effective population size, log10(Ne)", y_axis_type="log", tools='pan,box_zoom,xwheel_zoom,undo,xzoom_in,redo,reset,save', active_scroll='xwheel_zoom')

for counter,pop in enumerate(pop_name):
	leg_1.append((pop, [plot_b.line(name=pop, x=generations, y=pop_data[counter], muted_alpha=0.2, line_width=5, line_color=colours[counter]) ] )) # , line_dash=line_dash[counter]

plot_b.title.text_font_size= '18pt'

#plot_b.xaxis.axis_label=""
plot_b.xaxis.axis_label_text_font_size= "17pt"
plot_b.xaxis.major_label_text_font_size= "16pt"
...
plot_b.xaxis.major_tick_line_width= 4

#plot_b.yaxis.axis_label=""
...
plot_b.yaxis.major_tick_line_width= 4
...
plot_b.legend.location = "top_center"
plot_b.legend.click_policy="hide" #"mute"
plot_b.legend.label_text_font_size = '10pt'
plot_b.legend.label_text_font_style= "normal" # "bold" or "italic"
...
# pop_c
leg_1 = []
pop_name= ['Niger_Fulani_Balatungur','Niger_Fulani_Diffa','Niger_Fulani_Zinder','Cameroon_Fulani_Tcheboua','Chad_Fulani_Bongor','Chad_Fulani_Linia']
pop_data= ([Niger_Fulani_Balatungur,Niger_Fulani_Diffa,Niger_Fulani_Zinder,Cameroon_Fulani_Tcheboua,Chad_Fulani_Bongor,Chad_Fulani_Linia])
# Plotting pattern																				
colours= ['#E58300','#E2A600','#E2B407','#E58300','#F21A00','#EE3D00']
filling= ['#E58300','#E2A600','None','#E58300','None','#EE3D00']

plot_c = figure(title='', x_range=[4, 50], y_range=[1E2, 1E12], toolbar_location="above", width= 1200, height= 500,
	x_axis_label="Generations", y_axis_label="Effective population size, log10(Ne)", y_axis_type="log", tools='pan,box_zoom,xwheel_zoom,undo,xzoom_in,redo,reset,save', active_scroll='xwheel_zoom')

for counter,pop in enumerate(pop_name):
	leg_1.append((pop, [plot_c.line(name=pop, x=generations, y=pop_data[counter], muted_alpha=0.2, line_width=5, line_color=colours[counter]) ] )) # , line_dash=line_dash[counter]

plot_c.title.text_font_size= '18pt'
label_opts= dict(x=0, y=0, x_units='screen', y_units='screen', text_font_size='14pt')
plot_c.add_layout(caption, "below")

#plot_c.xaxis.axis_label=""
plot_c.xaxis.axis_label_text_font_size= "17pt"
plot_c.xaxis.major_label_text_font_size= "16pt"
...
plot_c.xaxis.major_tick_line_width= 4

#plot_c.yaxis.axis_label=""
plot_c.yaxis.axis_label_text_font_size= "17pt"
...
plot_c.yaxis.major_tick_line_width= 4
...
plot_c.legend.location = "top_center"
plot_c.legend.click_policy="hide" #"mute"
plot_c.legend.label_text_font_size = '10pt'
plot_c.legend.label_text_font_style= "normal" # "bold" or "italic"
