...
file <- "Tables/ADMIXTURE_Fulani_aDNA-Modern_DB.K6.ancestry"
out <- "02-Suppl_Figures/Figure_S14.pdf"
rmin <- 2
rmax <- 1.85*rmin
amin <- -268
amax <- 91
prgap <- 0.2
col <- c('ForestGreen','grey25','purple2','dodgerblue','grey75','violet','')
indcol <- 1
popcol <- 2
Kstart <- 3
Knum <- 1
...
# Add text
mtext("Figure S14. ADMIXTURE results at K=6 on the basis modern and aDNA individuals", side=3, adj=1, line=22, col="black", font=2, cex=3.3)
